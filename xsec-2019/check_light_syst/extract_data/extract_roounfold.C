#ifdef __CINT__
void extract_roounfold(unsigned int ds_idx = 0)
{
...
void extract_roounfold(unsigned int ds_idx = 0)
{
    ...
    vector<DSinfo> dsinfo = {
        ...
        {"dataset_def_name_newest_snapshot prod_caf_R17-11-14-prod4reco.CVNprong-respin.b_nd_genie_nonswap_fhc_nova_v08_full_lightmodel-lightdown-calibup_v1", "roounfold_study_lightup.txt"},
        {"dataset_def_name_newest_snapshot prod_caf_R17-11-14-prod4reco.CVNprong-respin.b_nd_genie_nonswap_fhc_nova_v08_full_lightmodel-lightup-calibdown_v1", "roounfold_study_lightdown.txt"},
    ...
    MakeTextListFile(dsinfo[ds_idx].ds_name, {kNumuSelected}, {dsinfo[ds_idx].out_fpn},
                    {&kRecoMuCostheta, &kRecoMuKE, &kRecoE, &kNumuE2018ND, &kRecoHadE, &kTrueMuCostheta, &kTrueMuKE, &kTrueE, &kTrueHadE, &wgt,
